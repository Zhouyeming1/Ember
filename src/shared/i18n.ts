...
const zh = {
  "update.title": "Ember 更新",
  "update.latest": "已是最新版本",
  "update.currentVersion": "当前版本：v{version}",
  "update.available": "发现新版本 Ember v{version}",
  ...
  "nav.maximize": "最大化或还原",
  "nav.closeWindow": "关闭",
  "nav.settingsTitle": "Ember 设置",
  "menu.settings": "设置",
  "menu.language": "语言",
  "menu.langZh": "中文 (中国)",
  "menu.langEn": "English (United States)",
  "nav.modelUnset": "未配置模型",
  "nav.manageKeys": "Ember 设置",
  "nav.configureKeys": "配置 Ember",
  ...
  "settings.skillsHint":
    "Skills 由 Ember 运行时加载。项目目录下的 skill 需要先信任该项目；用户目录下的 skill 全局可用。",
  ...
  "settings.mcpHint": "用户级 MCP（~/.ember/mcp.json）。命令填 npx …，或填 https 地址。改完后开新对话生效。",
  ...
  "about.intro":
    "把 DeepSeek 与兼容模型的推理变成可见、可控、可撤销的代码改动。会话与工作区数据留在本机，模型请求直达你配置的端点。",
  "about.originName": "Ember /ˈem.bər/ · 余烬、星火",
  "about.origin":
    "Ember 意为余烬——将熄未熄，随时能再点着。模型在你配置的端点上推理；桌面端守着这份余烬：每一轮改动都留在眼前，看得见、收得住，必要时用 /undo 拉回来。",
  "about.language": "界面语言",
  "about.langZh": "中文",
...
const en: Record<MessageKey, string> = {
  ...
  "nav.settingsTitle": "Ember settings",
  "menu.settings": "Settings",
  "menu.language": "Language",
  "menu.langZh": "中文 (中国)",
  "menu.langEn": "English (United States)",
  "nav.modelUnset": "Model not configured",
  "nav.manageKeys": "Ember settings",
  "nav.configureKeys": "Set up Ember",
  ...
  "toast.needJobCommands":
    "Stopping background jobs isn't supported by this agent — start a new thread to retry",
  ...
  "settings.skillsHint":
    "Skills are loaded by the Ember runtime. Project skills require trusting the workspace; user skills are always available.",
  ...
  "settings.searchJina": "Jina API key",
  "settings.searchExa": "Exa API key",
  "settings.mcpHint": "User-level MCP (~/.ember/mcp.json). Paste an npx command or an https URL. New threads pick up changes.",
  ...
  "about.intro":
    "Turns DeepSeek and compatible-model inference into visible, controllable, undoable code changes. Sessions and workspace data stay on your machine; model requests go straight to the endpoint you configure.",
  "about.originName": "Ember /ˈem.bər/ · a glowing coal, a live spark",
  "about.origin":
    "Ember is a coal that hasn't gone out. The model reasons at your endpoint while the desktop keeps the ember alive — every turn's changes stay visible, permissions stay tight, and the last turn can be pulled back with /undo.",
