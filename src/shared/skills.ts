/** Project-relative dirs scanned by the agent when the workspace is trusted. */
export const PROJECT_SKILL_ROOTS = [".agents/skills"] as const;

/** User-global dirs (always available; not listed in workspace @ picker). */
export const USER_SKILL_ROOTS = ["~/.ember/skills", "~/.agents/skills"] as const;
